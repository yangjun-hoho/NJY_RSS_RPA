...
def run():
    ...
    st.markdown('<p class="cargo-title">📦 화물운송사업 인허가 RPA 프로그램</p>', unsafe_allow_html=True)
    ...
    with tab1:
        ...
        with col2:
            try:
                ...
                buffered = BytesIO()
                intro_img.save(buffered, format="PNG")
                img_str = base64.b64encode(buffered.getvalue()).decode()
                
                # HTML과 CSS를 사용하여 그림자 효과가 있는 이미지 표시
                st.markdown(f"""
                <div style="text-align: center;">
                    ...
                    <p style="color: gray; font-size: 0.8em; margin-top: 5px;">프로그램 메인 화면</p>
                </div>
                """, unsafe_allow_html=True)
            except Exception as e:
    ...
    with tab2:
        ...
        try:
                ...
                <div style="text-align: center;">
                    ...
                    <p style="color: gray; font-size: 0.8em; margin-top: 5px;">신청접수 메인 화면</p>
                </div>
                """, unsafe_allow_html=True)
        except Exception as e:
                st.info("이미지(j002.png)를 불러올 수 없습니다.")
        ...
        st.markdown('<div class="feature-card">특별기능', unsafe_allow_html=True)
