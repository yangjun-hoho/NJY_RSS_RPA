...
import document_converter  # 새로 추가한 모듈 임포트
...
def main():
    ...
    # 앱 옵션들 정의 - 새로운 앱 추가
    app_options = ["AI 인사말씀 생성기", "AI 보도자료 생성기", "AI 문서자료 대본 생성기"]
    ...
    if app_choice == "AI 인사말씀 생성기":
        ...
        press_release.run()
    elif app_choice == "AI 문서자료 대본 생성기":
        document_converter.run()  # 새로 추가한 문서 변환 모듈 실행
